...
lower_bound = 10000; %kick size
tau = 4; %interkick time
 
save(strcat("different_rectangle_position_uniform", datestr(datetime), ".mat"), "lower_bound", "tau", "excursion_indicator", "excursion_time","mean_time_to_excursion", "probability_of_excursion")
