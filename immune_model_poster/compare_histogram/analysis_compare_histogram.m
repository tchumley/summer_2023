...
xlabel('mean time to excursion','FontSize',16)
ylabel('number of trials','FontSize',16)
title('mean of \tau = 1','FontSize',16)
ax = gca; 
...
xlabel('mean time to excursion','FontSize',16)
ylabel('number of trials','FontSize',16)
title('mean of \tau = 7','FontSize',16)
ax = gca; 
ax.XAxis.FontSize = 16;
ax.YAxis.FontSize = 16;
...
xlabel('mean time to excursion','FontSize',16)
ylabel('number of trials','FontSize',16)
title('mean of \tau = 10','FontSize',16)
ax = gca; 
ax.XAxis.FontSize = 16;
ax.YAxis.FontSize = 16;
...
xlabel('mean time to excursion','FontSize',16)
ylabel('number of trials','FontSize',16)
title('mean of \tau = 13','FontSize',16)
ax = gca; 
ax.XAxis.FontSize = 16;
ax.YAxis.FontSize = 16;
...
xlabel('mean time to excursion','FontSize',16)
ylabel('number of trials','FontSize',16)
title('mean of \tau = 16','FontSize',16)
ax = gca; 
ax.XAxis.FontSize = 16;
ax.YAxis.FontSize = 16;
...
xlabel('mean time to excursion','FontSize',16)
ylabel('number of trials','FontSize',16)
title('mean of \tau = 100','FontSize',16)
ax = gca; 
ax.XAxis.FontSize = 16;
ax.YAxis.FontSize = 16;
